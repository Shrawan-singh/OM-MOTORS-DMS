...
for (const endpoint of ['/auth/v1/settings','/rest/v1/rpc/my_access','/rest/v1/customers?select=id&limit=0','/rest/v1/catalog_products?select=id&limit=0','/rest/v1/billing_documents?select=id&limit=0']) {
